...
public class BuildingsAreaScript : MonoBehaviour {
	...
	public Vector2 CellWorldSize {
		get {
			return this._rect.TransformPoint (CellLocalSize) - this._rect.TransformPoint (Vector2.zero);
		}
	}
	...
	public Vector2 GetWorldPositionByGridPosition (int x, int y) {
		...
		var positionInLocalWithOffset = positionInLocal - (this._rect.rect.size / 2);
