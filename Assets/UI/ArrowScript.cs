...
public class ArrowScript : MonoBehaviour {
	...
	public void Init (Vector2 initialPosition, Vector2 targetPosition) {
		...
		lp.z = (this._targetPosition.y - CoreScript.Instance.Monster.MinPosition.y) / (CoreScript.Instance.Monster.MaxPosition.y - CoreScript.Instance.Monster.MinPosition.y);
